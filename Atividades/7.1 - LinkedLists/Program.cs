...
Page pageFirst = new() { Content = "Nowadays (...)" };
Page pageSecond = new() { Content = "Application (...)" };
Page pageThird = new() { Content = "A lot of (...)" };
Page pageFourth = new() { Content = "Do you know (...)" };
Page pageFifth = new() { Content = "While (...)" };
Page pageSixth = new() { Content = "Could you (...)" };
...
while (current != null)
{
    ...
    Console.WriteLine();
    Console.WriteLine(@$"Quote from 'Windows Application Development' Cookbook by Marcin
    Jamro,{Environment.NewLine} published by Packt Publishing in 2016.");
    Console.WriteLine();
